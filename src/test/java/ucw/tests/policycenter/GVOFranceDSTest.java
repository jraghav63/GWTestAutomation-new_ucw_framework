...
import static ucw.enums.CoverageTypes.GVODSC4_80;
import static ucw.enums.CoverageTypes.GVODSC7_150;
import static ucw.enums.Labels.DSC;
import static ucw.enums.ManagementType.DELEGATED;
import static ucw.enums.ManagementType.INSURED;
import static ucw.utils.extentreports.ExtentTestManager.startTest;

public class GVOFranceDSTest extends BaseTest {
    private PolicyCenter policyCenter;

    @BeforeClass
    public void goToPolicyCenter() {
        startTest("GVO France DS Certified validation");
    ...
    @Test(description = "France DS Certified policy creation", dataProvider = "getCoverageTypes")
    public void test_policyCreation_matchedDSCEligibility(String coverageType, int vehicleAge, long minMileage, long maxMileage) {
        dataSetInfo = coverageType + ", vehicle age = " + vehicleAge
                + ", mileage range from " + minMileage + " to " + maxMileage;
    ...
    public static Object[][] pricesForInsured() {
        return new String[][]{
                new String[]{GVODSC4_80,  "DS3", "178,18"},
                new String[]{GVODSC4_80,  "DS4", "274,51"},
                new String[]{GVODSC4_80,  "DS5", "384,6"},
                new String[]{GVODSC4_80,  "DS9", "384,6"},
                new String[]{GVODSC7_150, "DS3", "315,8"},
                new String[]{GVODSC7_150, "DS4", "499,28"},
                new String[]{GVODSC7_150, "DS5", "682,77"},
                new String[]{GVODSC7_150, "DS9", "682,77"},
        };
    }
    ...
    @Test(description = "France DS Certified other metrics per management types", dataProvider = "getManagementTypes")
