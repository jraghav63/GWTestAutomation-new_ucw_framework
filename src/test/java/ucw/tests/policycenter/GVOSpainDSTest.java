...
public class GVOSpainDSTest extends BaseTest {
    ...
    public static Object[][] getCoverageTypes() {
        return new Object[][]{
                ...
                new Object[]{GVODSC7_150, 4, 80001, 150000},
                new Object[]{GVODSC7_150, 7, 100,   150000}
        };
    }

    @Test(description = "Spain DS Certified policy creation", dataProvider = "getCoverageTypes")
    ...
    public static Object[][] pricesForInsured() {
        return new String[][]{
                new String[]{GVODSC4_80,  "DS3", "223,98"},
                new String[]{GVODSC4_80,  "DS4", "304,42"},
                new String[]{GVODSC4_80,  "DS5", "571,64"},
                new String[]{GVODSC4_80,  "DS7", "571,64"},
                new String[]{GVODSC4_80,  "DS9", "571,64"},
                new String[]{GVODSC7_150, "DS3", "174,4" },
                new String[]{GVODSC7_150, "DS4", "253"   },
                new String[]{GVODSC7_150, "DS5", "431,45"},
                new String[]{GVODSC7_150, "DS7", "431,45"},
                new String[]{GVODSC7_150, "DS9", "431,45"},
        };
    }
    ...
    public static Object[][] getManagementTypes() {
        return new String[][] {
                new String[] {INSURED,   "28",    "0", "0,0815", "0", "1", "3", "0,0815", "1"},
                new String[] {DELEGATED, "27,84", "0", "0,21",   "0", "1", "3", "0,0815", "1"},
        };
    }

    @Test(description = "Spain DS Certified other metrics per management types", dataProvider = "getManagementTypes")
