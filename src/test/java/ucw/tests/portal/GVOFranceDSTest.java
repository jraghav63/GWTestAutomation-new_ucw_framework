...
public class GVOFranceDSTest extends BaseTest {
    ...
    public void goToCenters() {
        startTest("GVO France DS Certified validation in Portal");
    ...
    public static Object[][] getCoverageTypes() {
        return new Object[][] {
                new Object[]{GVODSC4_80,  4, 100,   80000,  "24"},
                new Object[]{GVODSC7_150, 4, 80000, 150000, "12"},
                new Object[]{GVODSC7_150, 7, 100,   150000, "12"}
        };
    }

    @Test(description = "France DS Certified policy creation and check duration in Portal", dataProvider = "getCoverageTypes")
