...
public class VehicleErrorTranslationTest extends BaseTest {
    ...
    public void test_licenseSearch(String lang, String warningMessage) {
        ...
        portal.atSubmissionPage().inputNewVIN();
        portal.atSubmissionPage().inputLicensePlate();
    ...
    @Test(description = "If any(/all) field details is not retrieved from VIN search results, then user should get a Informantional message",
    ...
    public void test_VINSearchRetrieval(String lang, String warningMessage) {
        ...
        portal.atSubmissionPage().goToVehicleDetails();
        portal.atSubmissionPage().inputNewVIN();
        portal.atSubmissionPage().searchVIN();
        String actualMessage = portal.atSubmissionPage().getErrorMessage();
        assertEquals(actualMessage, warningMessage, "Actual message is not matched with expected");
    }

    @Test(description = "In case of Partial results received from License plate or in case of No results/Partial results received from VIN search then display a warning messsage.",
            dataProvider = "getVINRetrieveMessage")
    public void test_VINSearchRetrieval_noResult(String lang, String warningMessage) {
        ...
        portal.atSubmissionPage().submitContactInfo();
        portal.atSubmissionPage().goToVehicleDetails();
        portal.atSubmissionPage().inputVIN("1GCCS136358115682");
        portal.atSubmissionPage().inputLicensePlate();
        portal.atSubmissionPage().searchLicensePlate();
        portal.atSubmissionPage().searchVIN();
        String actualMessage = portal.atSubmissionPage().getErrorMessage();
    ...
    public void test_multipleVINResults(String lang, String warningMessage) {
        ...
        portal.atSubmissionPage().submitContactInfo();
        portal.atSubmissionPage().goToVehicleDetails();
        portal.atSubmissionPage().inputVIN("1NXBA02E3VZ664920");
        portal.atSubmissionPage().inputLicensePlate();
        portal.atSubmissionPage().searchLicensePlate();
        portal.atSubmissionPage().searchVIN();
        String actualMessage = portal.atSubmissionPage().getErrorMessage();
