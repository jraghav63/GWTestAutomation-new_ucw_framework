...
public class GVOSpainARCTest extends BaseTest {
    ...
    public void goToCenters() {
        startTest("UCWAR-31: GVO Spain - Alfa Romeo Certified Evolution-Virtual Product & Rate book in Portal");
    ...
    @Test(description = "Spain Alfa Romeo Certified policy creation and check duration in Portal", dataProvider = "getDuration")
    ...
    @Test(description = "Spain Alfa Romeo Certified policy creation and check duration in Portal", dataProvider = "getDurations")
